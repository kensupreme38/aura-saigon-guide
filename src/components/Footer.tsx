    ...
    <footer className="bg-ktv-darker border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Thông tin liên hệ */}
          <div>
            <h3 className="text-xl font-bold text-foreground mb-2 uppercase">CONTACT BOOKING</h3>
            ...
            <div className="flex items-start mb-4">
              <div className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center flex-shrink-0 mr-3">
              ...
              <div>
                ...
                <a href="https://wa.me/6582808072" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-smooth">
                  +65 8280 8072
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start">
              <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 mr-3 overflow-hidden">
                <img 
              ...
              <div>
                ...
                <a href="https://t.me/@asianightlifesg" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-smooth">
                  @asianightlifesg
                </a>
              </div>
            </div>
