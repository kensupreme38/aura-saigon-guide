        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <Button variant="outline" size="sm" aria-label="Visit our Facebook page">
                <Facebook className="w-4 h-4" aria-hidden="true" />
              </Button>
              <Button variant="outline" size="sm" aria-label="Visit our Instagram page">
                <Instagram className="w-4 h-4" aria-hidden="true" />
              </Button>
              <Button variant="outline" size="sm" aria-label="Visit our YouTube channel">
          ...
          <div>
            ...
            <div className="flex items-start mb-4">
              <div className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center flex-shrink-0 mr-3" aria-hidden="true">
